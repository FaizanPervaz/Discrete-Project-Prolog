%testcase2
sameSection(Student1,Student2,CourseName):-

        course(CID,CourseName),
        coursesection(CID,Section),

        student(Roll1,Student1),
        student(Roll2,Student2),

        section(Roll1, Section1),
        section(Roll2, Section2),

        Section = Section1,
        Section = Section2.

%sameSection("Mohammad Usman Chaudhary","Moeiz Ali","Data Structures (CS)").
%sameSection("Mohammad Usman Chaudhary","Moattar Zeest Rana","Data Structures (CS)").


%testcase3
exactexam(Course1,Course2):-
    course(CID1,Course1),
    examTime(Day1,S1,E1 ,CID1,_) ,

    course(CID2,Course2),
    examTime(Day2,S2,E2,CID2,_),
...
%exactexam("Discrete Structures (CS)","Data Structures (CS)").
%exactexam("Discrete Structures (CS)","Marketing Management").
...
%student("18I-1234","Mohammad Usman Chaudhary").
%sameRollNo("Mohammad Usman Chaudhary").

%testcase5
sameRoom(Course1,Course2) :-

    course(CID1,Course1),
    examTime(Day1,S1,E1 ,CID1,R1) ,

    course(CID2,Course2),
    examTime(Day2,S2,E2,CID2,R2),
...
%examTime("1","9:00","10:00","CS218","C-301").
%sameRoom("Discrete Structures (CS)","Data Structures (CS)").

%testcase6
sheTeaches(Name,Course):-
    course(CourseID,Course),
    checkcourse(CourseID,Name).

%sheTeaches("Khadija Farooq","Discrete Structures (CS)").
%sheTeaches("Khadija Farooq","Data Structures (CS)").


%testcase7
%teachesTwoCourses("Shams Farooq").
%teachesTwoCourses("Khadija Farooq").
...
%testcase8
%switching("C-301","C-302","1","9:00","10:00").
%switching("C-301","C-303","1","9:00","10:00").

    switching(Room1,Room2,Day,Start,End):-
    capacity(Room1,C1),
    capacity(Room2,C2),
    C1 = C2,
    examTime(Day, Start, End,_,Room1).

%mypredicate
checkcourse("CS218","Adnan Tariq"):-      instructor(EmailID,"Adnan Tariq")     ,  coursesection("CS218",SecID)  ,      teaches(EmailID,SecID).
checkcourse("CS218","Hassan Mustafa"):-   instructor(EmailID,"Hassan Mustafa")  ,  coursesection("CS218",SecID)  ,      teaches(EmailID,SecID).
checkcourse("CS218","Saba Rasheed"):-     instructor(EmailID,"Saba Rasheed")    ,  coursesection("CS218",SecID)  ,      teaches(EmailID,SecID).
checkcourse("EE229","Shams Farooq"):-     instructor(EmailID,"Shams Farooq")    ,  coursesection("EE229",SecID)  ,      teaches(EmailID,SecID).
checkcourse("EE227","Shams Farooq"):-     instructor(EmailID,"Shams Farooq")    ,  coursesection("EE227",SecID)  ,      teaches(EmailID,SecID).
checkcourse("CS218","Noor ul Ain"):-      instructor(EmailID,"Noor ul Ain")     ,  coursesection("CS218",SecID)  ,      teaches(EmailID,SecID).
checkcourse("CS218","Shehreyar Rashid"):- instructor(EmailID,"Shehreyar Rashid"),  coursesection("CS218",SecID)  ,      teaches(EmailID,SecID).
checkcourse("DS201","Umair Arshad"):-     instructor(EmailID,"Umair Arshad")    ,  coursesection("DS201",SecID)  ,      teaches(EmailID,SecID).
checkcourse("CY201","Zeeshan Qaiser"):-   instructor(EmailID,"Zeeshan Qaiser")  ,  coursesection("CY201",SecID)  ,      teaches(EmailID,SecID).
checkcourse("EE229","Rohail Gulbaz"):-    instructor(EmailID,"Rohail Gulbaz")   ,  coursesection("EE229",SecID)  ,      teaches(EmailID,SecID).
checkcourse("EE229","Ameen Chilwan"):-    instructor(EmailID,"Ameen Chilwan")   ,  coursesection("EE229",SecID)  ,      teaches(EmailID,SecID).
checkcourse("EE229","Farwa Batool"):-     instructor(EmailID,"Farwa Batool")    ,  coursesection("EE229",SecID)  ,      teaches(EmailID,SecID).
checkcourse("CS211","Khadija Farooq"):-   instructor(EmailID,"Khadija Farooq")  ,  coursesection("CS211",SecID)  ,      teaches(EmailID,SecID).
checkcourse("CS211","Shafaq Riaz"):-      instructor(EmailID,"Shafaq Riaz")     ,  coursesection("CS211",SecID)  ,      teaches(EmailID,SecID).
checkcourse("CS211","Amna Irum"):-        instructor(EmailID,"Amna Irum")       ,  coursesection("CS211",SecID)  ,      teaches(EmailID,SecID).
checkcourse("CS211","Arshad Islam"):-     instructor(EmailID,"Arshad Islam")    ,  coursesection("CS211",SecID)  ,      teaches(EmailID,SecID).
checkcourse("EE227","Shoaib Mehboob"):-   instructor(EmailID,"Shoaib Mehboob")  ,  coursesection("EE227",SecID)  ,      teaches(EmailID,SecID).
checkcourse("MT104","Irfan Shah"):-       instructor(EmailID,"Irfan Shah")      ,  coursesection("MT104",SecID)  ,      teaches(EmailID,SecID).
checkcourse("MT104","Zunaira Sajid"):-    instructor(EmailID,"Zunaira Sajid")   ,  coursesection("MT104",SecID)  ,      teaches(EmailID,SecID).
checkcourse("MT104","Rafia Latif"):-      instructor(EmailID,"Rafia Latif")     ,  coursesection("MT104",SecID)  ,      teaches(EmailID,SecID).
checkcourse("MT104","Sara Aziz"):-        instructor(EmailID,"Sara Aziz")       ,  coursesection("MT104",SecID)  ,      teaches(EmailID,SecID).
checkcourse("MT104","Sumaira Azhar"):-    instructor(EmailID,"Sumaira Azhar")   ,  coursesection("MT104",SecID)  ,      teaches(EmailID,SecID).
checkcourse("SS118","Farah Naz"):-        instructor(EmailID,"Farah Naz")       ,  coursesection("SS118",SecID)  ,      teaches(EmailID,SecID).
checkcourse("MG220","Aqeel Shahzad"):-    instructor(EmailID,"Aqeel Shahzad")   ,  coursesection("MG220",SecID)  ,      teaches(EmailID,SecID).
checkcourse("MG220","Sahar Arshad"):-     instructor(EmailID,"Sahar Arshad")    ,  coursesection("MG220",SecID)  ,      teaches(EmailID,SecID).
checkcourse("MG223","Inji Akhtar"):-      instructor(EmailID,"Inji Akhtar")     ,  coursesection("MG223",SecID)  ,      teaches(EmailID,SecID).
checkcourse("MG223","Danial Hassan"):-    instructor(EmailID,"Danial Hassan")   ,  coursesection("MG223",SecID)  ,      teaches(EmailID,SecID).
...
teaches("aqeel.shahzad@nu.edu.pk","B").	
teaches("sahar.arshad@nu.edu.pk","C").	
...
examTime("1","9:00","10:00","CS211","C-306").
...
examTime("3","9:00","10:00","MG220","C-306").
...
examTime("4","12:20","13:20","MT104","C-301").
examTime("4","12:20","13:20","MT104","C-302").
examTime("4","12:20","13:20","MT104","C-303").
examTime("4","12:20","13:20","MT104","C-304").
examTime("4","12:20","13:20","MT104","C-305").
examTime("4","12:20","13:20","MT104","C-307").
examTime("4","12:20","13:20","MT104","C-308").
examTime("4","12:20","13:20","MT104","C-309").
examTime("4","12:20","13:20","MT104","C-310").
examTime("4","12:20","13:20","MT104","C-311").
examTime("4","12:20","13:20","MT104","C-402").
examTime("4","12:20","13:20","MT104","C-402").
examTime("4","12:20","13:20","MT104","C-403").
examTime("4","12:20","13:20","MT104","C-404").
examTime("4","12:20","13:20","MT104","C-405").
examTime("4","12:20","13:20","MT104","C-408").
examTime("4","12:20","13:20","MT104","C-409").
examTime("5","12:20","13:20","EL229","C-301").
examTime("5","12:20","13:20","EL229","C-302").
examTime("5","12:20","13:20","EL229","C-303").
examTime("5","12:20","13:20","EL229","C-304").
examTime("5","12:20","13:20","EL229","C-305").
examTime("5","12:20","13:20","EL229","C-307").
examTime("5","12:20","13:20","EL229","C-308").
examTime("5","12:20","13:20","EL229","C-309").
